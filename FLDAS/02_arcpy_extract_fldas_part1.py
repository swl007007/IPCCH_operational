...
if __name__ == "__main__":
    ...
    # Define output files
    mean_output_csv = os.path.join(output_folder, "FLDAS_mean_extraction_results_p1.csv")
    std_output_csv = os.path.join(output_folder, "FLDAS_std_extraction_results_p1.csv")
