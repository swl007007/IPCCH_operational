...
try:
    ...
    # Input parameters
    tif_folder = r"C:\Users\swl00\IFPRI Dropbox\Weilun Shi\Processed_Dataset\MODIS_MOD13A3_EVI_Monthly\update"
    shapefile = r"C:\Users\swl00\IFPRI Dropbox\Weilun Shi\Google fund\Analysis\1.Source Data\assembled_IPCCH\ipcch_admin_geometry.shp"
    output_folder = r"C:\Users\swl00\IFPRI Dropbox\Weilun Shi\Google fund\Analysis\1.Source Data\EVI\output_update"
    id_field = "admin_code"
    ...
    tif_files = [os.path.join(tif_folder, f) for f in os.listdir(tif_folder)
                 if f.endswith('.tif') and "MOD13A3" in f]
