...
try:
    ...
    # Input parameters from the original script
    tif_folder = r"C:\Users\swl00\IFPRI Dropbox\Weilun Shi\Processed_Dataset\GOSIF_GPP_Monthly\GOSIF_GPP_mean"
    shapefile = r"C:\Users\swl00\IFPRI Dropbox\Weilun Shi\Google fund\Analysis\1.Source Data\Outcome\ch_scaffold_fixed.shp"
    output_folder = r"C:\Users\swl00\IFPRI Dropbox\Weilun Shi\Google fund\Analysis\1.Source Data\GOSIF_GPP\output_ch"
    id_field = "fid"
    ...
    for tif_file in tqdm(tif_files, desc="Processing TIF files", unit="file"):
        ...
        year_month = filename.split("GOSIF_GPP_")[1].split("_Mean")[0]
    ...
    output_csv = os.path.join(output_folder, "GOSIF_GPP_extraction_results_CH.csv")
